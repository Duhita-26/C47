...
function preload(){
//PRELOADING THE IMAGES FOR GAME

ground_image=loadImage("Background1.jpg");
  
  girl_running=loadAnimation("minion1.jpg")
                            //  "Run (2).png",
                            //  "Run (3).png",
                            //  "Run (4).png",
                            //  "Run (5).png",
...
zombie_idle=loadImage("zombie.png");
...
girlImage=loadImage("minion1.jpg");
}
...
//THE CODES FOR GAME OVER IMAGE
gameOver = createSprite(300,100);
gameOver.addImage(gameOverImage);
 
//THE CODES FOR RESTART THE GAME
...
//WRITING THE CODES IN GAME STATE = PLAY
   if (gameState===PLAY){
...
//WRITING THE CODES IN GAME STATE = "END"
